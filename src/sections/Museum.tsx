      ...
      <div className="container-custom space-y-10 md:space-y-12">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
            <div className="space-y-3">
              <span className="mq-kicker">{museumConfig.scriptText}</span>
              <h1 className="mq-title max-w-xl">{museumConfig.mainTitle}</h1>
            </div>
            <div className="space-y-5 lg:pl-4">
              <p className="mq-copy text-lg md:text-xl max-w-none">
          ...
          <div className="mq-panel bg-gradient-to-r from-[#38469D] to-[#2c377d] text-white p-7 md:p-8">
          ...
          <div className="grid sm:grid-cols-2 xl:grid-cols-4 gap-4">
            {museumConfig.timeline.slice(0, 4).map((event, index) => (
              ...
              >
                ...
                <p className="mq-copy text-base md:text-left">{event.event}</p>
              </div>
            ))}
          </div>
            ...
            {museumConfig.tabs.slice(0, 3).map((tab, index) => (
              ...
              >
                ...
                <div className={`mq-card p-6 md:p-8 ${index % 2 === 0 ? '' : 'lg:order-1'}`}>
                  ...
                  <p className="mq-copy text-base md:text-left mb-5">{withSinoAfricaLink(tab.content.description)}</p>
                  <div className="rounded-lg bg-slate-50 border border-slate-200 p-4 flex items-start gap-3">
                    ...
                    <p className="mq-copy text-base md:text-left text-slate-700">{tab.content.highlight}</p>
                  </div>
                </div>
              </div>
            ))}
