  ...
  return (
    ...
    >
      ...
      <div className="preloader-text mb-6">
        <img src="/brand/pag-logo-symbol.png" alt="PAG" className="w-12 h-12 object-contain" />
      </div>
      ...
      <div className="preloader-text text-center" style={{ animationDelay: '0.2s' }}>
        ...
        <p className="font-sans text-sm text-gold-400 tracking-[0.2em] uppercase">{preloaderConfig.brandSubname}</p>
      </div>
